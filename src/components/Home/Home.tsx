...
function Home() {
    return (
        <div className='sm:py-20 py-16 flex flex-col gap-1 items-center'>
            <Link href={'#'} className='text-sm px-4 rounded-md py-1 dark:bg-[#27272a] bg-[#dddddd]  font-semibold flex items-center gap-2'>
                <DashboardIcon />
            ...
            <p className="leading-5 mt-3 text-lg font-semibold text-center w-full sm:px-[300px] px-10">
